# Generated by Django 5.0.6 on 2026-05-10 12:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('staff', 'Omborchi'), ('master', 'Usta')], default='master', max_length=10, verbose_name='Rol')),
                ('phone', models.CharField(blank=True, max_length=20, validators=[apps.core.utils.phone_number_validator], verbose_name='Telefon')),
                ('address', models.TextField(blank=True, verbose_name='Manzil')),
                ('passport', models.CharField(blank=True, max_length=20, verbose_name='Passport')),
                ('preferred_currency', models.CharField(choices=[('uzs', "So'm"), ('usd', 'Dollar')], default='uzs', max_length=3, verbose_name='Afzal valyuta')),
